...
def update_ui(model_choice):
    ...
    text_update = dict(visible=("espeak" in cond_names))
    language_update = dict(visible=("espeak" in cond_names))
    speaker_audio_update = dict(visible=("speaker" in cond_names))
    prefix_audio_update = dict(visible=True)
    emotion1_update = dict(visible=("emotion" in cond_names))
    emotion2_update = dict(visible=("emotion" in cond_names))
    emotion3_update = dict(visible=("emotion" in cond_names))
    emotion4_update = dict(visible=("emotion" in cond_names))
    emotion5_update = dict(visible=("emotion" in cond_names))
    emotion6_update = dict(visible=("emotion" in cond_names))
    emotion7_update = dict(visible=("emotion" in cond_names))
    emotion8_update = dict(visible=("emotion" in cond_names))
    vq_single_slider_update = dict(visible=("vqscore_8" in cond_names))
    fmax_slider_update = dict(visible=("fmax" in cond_names))
    pitch_std_slider_update = dict(visible=("pitch_std" in cond_names))
    speaking_rate_slider_update = dict(visible=("speaking_rate" in cond_names))
    dnsmos_slider_update = dict(visible=("dnsmos_ovrl" in cond_names))
    speaker_noised_checkbox_update = dict(visible=("speaker_noised" in cond_names))
    unconditional_keys_update = dict(
